export const portada = {
	...
	enlaces:[
        {
            claseCaja: "col-12 p-1 p-md-3 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/cero_corrupcion.jpg",
        },
        {
            claseCaja: "col-12 p-1 p-md-3 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/cartilla.jpg",
        },
        {
            claseCaja: "col-12 p-1 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/me_canso.jpg",
        },
        {
            claseCaja: "col-6 col-md-6 p-1 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/ipomex.jpg",
        },
        {
            claseCaja: "col-6 col-md-6 p-1 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/leyes.jpg",
        },
        {
            claseCaja: "col-6 col-md-6 p-1 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/aviso_privacidad.jpg",
        },
        {
            claseCaja: "col-6 col-md-6 p-1 p-md-3",
            enlace: "http://ecatepec.gob.mx",
            imagen: "assets/images/portada/infoem.jpg",
        }
    ]
}