...
export class AmbienteComponent implements OnInit {
    ...
    enviarDatosFirebase(pushId, perfilUsuario) {
        ...
        updates[`usuarios/${uid}/ambiente/${pushId}`] = this.formDirectivePeticiones.value
        updates[`admin/peticiones/ambiente/${pushId}`] = this.formDirectivePeticiones.value
    ...
    componerDatosUsuario(pushId) {
        ...
        usuarioActualizado.direccion1 = this.formGroupPeticiones.value.direccion
